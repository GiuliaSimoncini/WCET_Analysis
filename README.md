...
- `bench`: contine i benchmark che sono stati usati per l'analisi e sono una parte di quelli presenti in TACLeBench
- `calcolo_tempi_esecuzione.py` è il codice Python che è stato usato per calcolare i tempi di esecuzione dei vari benchmarks
